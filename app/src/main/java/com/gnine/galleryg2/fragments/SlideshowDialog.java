...
import com.gnine.galleryg2.adapters.SlideShowAdapter;
...
public class SlideshowDialog extends DialogFragment {
    ...
    private ArrayList<ImageData> dataSlideshow;

    public SlideshowDialog(ArrayList<ImageData> dataSlideshow) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        confirmBtn.setOnClickListener(view1 -> Objects.requireNonNull(getDialog()).dismiss());
