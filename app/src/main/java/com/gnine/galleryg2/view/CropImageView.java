...
public class CropImageView extends TransformImageView{
    ...
    private ICropBoundsChangeListener mCropBoundsChangeListener;
    ...
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
                                 @Nullable IBitmapCropCallback cropCallback) {
        cancelAllAnimations();
    ...
    @Nullable
    public ICropBoundsChangeListener getCropBoundsChangeListener() {
        return mCropBoundsChangeListener;
    }

    public void setCropBoundsChangeListener(@Nullable ICropBoundsChangeListener cropBoundsChangeListener) {
